...
export default function MobileNavbar() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 w-[95%] max-w-md bg-white shadow-2xl rounded-2xl px-4 py-3 flex justify-between items-center xl:hidden block z-50 border">
      {menus.map((item) => {
